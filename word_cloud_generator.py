...
path_to_model = Path('venv/lib/python3.10/site-packages/en_dual_none_contextual/en_dual_none_contextual-0.3.1')
### stopwords_files
...
# Combine the scaled frequencies
        ...
        wc_image_path = os.path.join(
            "website/static/wordcloud", f"wordcloud_{timestamp}.png")
    ...
    def generate_wordcloud_type(self, input_data, cloud_type, language, cloud_measure, wordlist=None):
        ...
        if cloud_type == 'all_words':
            ...
            if language == 'en':
                ...
                corcencc_sementic_tags = pd.read_csv('website/static/keness/Cy_tags.csv')
